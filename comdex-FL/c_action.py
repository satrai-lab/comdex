...
# For more information and updates, visit: [REDACTED]
...
#Description: This function is used to create a new NGSI-LD entity in the REDACTED node.
#Parameters:
...
# Function: GET
# Description: This function is used to retrieve entities from the REDACTED node, similar to the NGSI-LD GET entities operation.
# Parameters:
#   - broker: The name or IP address of the broker.
#   - port: The port number of the broker.
...
def usage():
    ...
    print("-b, --broker_address      Specify the address of the MQTT broker of the REDACTED node")
    print("-p, --port                Specify the port number of the MQTT broker of the REDACTED node")
...
#REDACTED is an ngsild compliant "broker" that utilises a running MQTT broker
